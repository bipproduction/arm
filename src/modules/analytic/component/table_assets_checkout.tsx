...
import { ActionIcon, Box, Center, Group, Pagination, ScrollArea, SimpleGrid, Table, Text } from "@mantine/core"
...
export function TableAssetsCheckout() {
                                        ...
                                        <tr key={item.id}>
                                            ...
                                            <td>
                                                <Center>
                                                    <ActionIcon
                                                        color="dark"
                                                        onClick={() => router.push(`/dashboard/activities-analytic/assets-checkout/` + item.no)}
                                                    >
